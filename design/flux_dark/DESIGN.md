...
- **Display Scale (`display-lg` to `display-sm`):** Use these for hero numbers and "Dark-style" big-statement headers. Reduce letter-spacing by -2% for a tighter, editorial feel.
